    ...
    Rectangle{
        ...
        ColumnLayout{
            ...
            RowLayout {
                ...
                // Button {
                //     id: deptTodoListButton
                //     text: "Department Todo";
                //     font.pixelSize: 15;
                //     background: Rectangle {
                //         color: "#4CAF50" // Green
                //         radius: 6
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        Rectangle {
                            ...
                            anchors.horizontalCenter: parent.horizontalCenter
                            width: managerBox.width*0.85
                            height: managerBox.height*0.75
                            color: "#9CB071"
                ...
                Rectangle{
                    ...
                    Column{
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                Layout.preferredWidth: managerBox.width * 0.5
                                Layout.preferredHeight: managerBox.height * 0.05
                                color: "lightblue"
                                TextField {
                                    id: titleInput
                    ...
                    Column {
                        ...
                        RowLayout{
                            ...
                            Rectangle {
                                ...
                                width: 20
                                color: "green"
                                anchors.right: aboutMyTodos.right
